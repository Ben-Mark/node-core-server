...
router.post('/', (req, res) => {
    ...
    youtubeSearchWithoutApi(searchWord)
        ...
        .then(searchResults => searchResults.slice(0, parseInt(process.env.MAX_RESULTS+5)))
        .then(searchResults => {
        ...
        .then(songsInfo => {
            ...
            const sortedSongs = songsInfo
                .filter(songInfo => {
                    ...
                    return songInfo.duration > 100 && songInfo.likePercentage && isNotAnAdvertise
                })
                .sort(function (a, b) {
